...
wget -N --no-check-certificate https://github.com/SPIDER BUOY/BBRplus/releases/download/bbr5.15/Debian-Ubuntu_Optional_linux-headers-5.15.96-bbrplus_5.15.96-bbrplus-1_amd64.deb >/dev/null 2>&1
wget -N --no-check-certificate https://github.com/SPIDER BUOY/BBRplus/releases/download/bbr5.15/Debian-Ubuntu_Required_linux-image-5.15.96-bbrplus_5.15.96-bbrplus-1_amd64.deb >/dev/null 2>&1
