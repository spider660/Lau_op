...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/spider660/Lau_op/main/password"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/spider660/Lau_op/main/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/spider660/Lau_op/main/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/spider660/Lau_op/main/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/spider660/Lau_op/main/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/spider660/Lau_op/main/issue.net"
...
#Optimasi Speed Mod By SPIDER BUOY
Add_To_New_Line(){
