...
export sem=$( curl -s https://raw.githubusercontent.com/spider660/Lau_op/main/test/versions)
...
21) clear ; clearlog ;;
#99) clear ; update ;;
22) clear ; wget https://raw.githubusercontent.com/spider660/Lau_op/main/cf.sh && chmod +x cf.sh && ./cf.sh ;;
